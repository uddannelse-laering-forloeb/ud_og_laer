 ...
 *   Available variables.
 */
function ulf_silkeborg_preprocess_html(&$variables) {
 ...
 *   Available variables.
 */
function ulf_silkeborg_preprocess_page(&$variables) {
 ...
 *   Available variables.
 */
function ulf_silkeborg_preprocess_front_page(&$variables) {
 ...
 *  The menu tree array.
 */
function ulf_silkeborg_menu_tree__main_menu ($variables) {
 ...
 *  The menu tree array.
 */
function ulf_silkeborg_menu_tree__menu_about_ulf ($variables) {
  // Strip default main menu tree of wrappers.
  return $variables['tree'];
}
 ...
 */
function ulf_silkeborg_menu_link__main_menu($variables){
 ...
 *   Available variables.
 */
function ulf_silkeborg_preprocess_node(&$variables) {
  ...
  if ($variables['view_mode'] == 'teaser') {
    ...
    if ($variables['type'] == 'news') {
      $variables['teaser_content'] = _ulf_silkeborg_teaser_filter($variables['content']['field_teaser']['0']['#markup']);
      $variables['theme_hook_suggestions'][] = 'node__news_teaser';
    }
    else {
      $variables['teaser_content'] = _ulf_silkeborg_teaser_filter($variables['content']['field_full_description']['0']['#markup']);
    }
  }
 ...
 *   Available variables.
 */
function ulf_silkeborg_preprocess_user_profile(&$variables) {
 ...
 *   Available variables.
 */
function ulf_silkeborg_preprocess_field(&$variables) {
 ...
 *   Available variables.
 */
function ulf_silkeborg_preprocess_panels_pane(&$variables) {
 ...
 */
function ulf_silkeborg_panels_default_style_render_region($variables) {
  $output = '';
 ...
 */
function ulf_silkeborg_links__system_main_menu($variables) {
  $html = '';
 ...
 */
function ulf_silkeborg_menu_link__menu_about_ulf($variables) {
  $element = $variables ['element'];
  $sub_menu = '';
 ...
 */
function ulf_silkeborg_item_list($variables) {
 ...
 */
function ulf_silkeborg_date_display_range($variables) {
 ...
 */
function ulf_silkeborg_file_link($variables) {
  $file = $variables['file'];
 ...
 *  The stripped string.
 */
function _ulf_silkeborg_teaser_filter($str) {
  // Clean out headlines.
  $str = strip_tags($str);
